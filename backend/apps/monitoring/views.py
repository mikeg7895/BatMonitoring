...
from apps.monitoring.serializers import SampleSerializer, VariableSerializer, UnitMeasureSerializer
from apps.monitoring.models import Sampling, Variable, UnitMeasure
